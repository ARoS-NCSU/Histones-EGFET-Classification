...
def clean_egfet_data(
    ...
    for experiment, concentration, trial, cycle in indices:
        ...
        if temp.size < 25:  # determined by looking at cycle size histograms
            # remove the data
...
@click.option(
    "--data_path",
    type=str,
    default="/home/jalex/Data/aros/Histones/PavlidisGroup/EGFET Data/",
    required=True,
...
@click.option(
    ...
    type=Path,
    required=False,
    default=Path("/home/jalex/Data/aros/Histones/PavlidisGroup/EGFET Processed Data/"),
...
@click.option(
    ...
    type=Path,
    required=False,
    default=Path("/home/jalex/Projects/aros/histones/Histones/results"),
